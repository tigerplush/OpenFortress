...
impl BlockType {
    ...
    fn texture_index(
        ...
        if x_offset == 0 && y_offset == 0 {
            ...
            } else if flags & BOTTOM_LEFT_MASK == WEST
                || flags & BOTTOM_LEFT_MASK == WEST | SOUTH_WEST
            {
                return Some((TileTextureIndex(2), tile_flip));
            } else if flags & BOTTOM_LEFT_MASK == SOUTH
                || flags & BOTTOM_LEFT_MASK == SOUTH | SOUTH_WEST
            {
            ...
            if flags & UPPER_LEFT_MASK == ISOLATED || flags & UPPER_LEFT_MASK == NORTH_WEST {
                return Some((TileTextureIndex(3), tile_flip));
            } else if flags & UPPER_LEFT_MASK == WEST
                || flags & UPPER_LEFT_MASK == WEST | NORTH_WEST
            {
                return Some((TileTextureIndex(2), tile_flip));
            } else if flags & UPPER_LEFT_MASK == NORTH
                || flags & UPPER_LEFT_MASK == NORTH | NORTH_WEST
            {
                return Some((TileTextureIndex(1), tile_flip));
            ...
            if flags & BOTTOM_RIGHT_MASK == ISOLATED || flags & BOTTOM_RIGHT_MASK == SOUTH_EAST {
                return Some((TileTextureIndex(3), tile_flip));
            } else if flags & BOTTOM_RIGHT_MASK == EAST
                || flags & BOTTOM_RIGHT_MASK == EAST | SOUTH_EAST
            {
                return Some((TileTextureIndex(2), tile_flip));
            } else if flags & BOTTOM_RIGHT_MASK == SOUTH
                || flags & BOTTOM_RIGHT_MASK == SOUTH | SOUTH_EAST
            {
                return Some((TileTextureIndex(1), tile_flip));
            ...
            {
                return Some((TileTextureIndex(2), tile_flip));
            } else if flags & UPPER_RIGHT_MASK == NORTH
                || flags & UPPER_RIGHT_MASK == NORTH | NORTH_EAST
            {
                return Some((TileTextureIndex(1), tile_flip));
