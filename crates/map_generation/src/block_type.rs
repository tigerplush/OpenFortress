...
impl BlockType {
    ...
    const MASKS: [(u8, u8, usize); 46] = [
        ...
        (0b11111111, 0b01011110, BlockType::UPPER_RIGHT_L_WITH_W_AND_S),
        (0b11111111, 0b11011010, BlockType::BOTTOM_RIGHT_L_WITH_W_AND_N),
        (0b11111111, 0b01111010, BlockType::BOTTOM_LEFT_L_WITH_E_AND_N),
        (0b11111111, 0b01111110, BlockType::UPPER_RIGHT_AND_BOTTOM_LEFT_L),
        (0b11111111, 0b11011011, BlockType::UPPER_LEFT_AND_BOTTOM_RIGHT_L),
